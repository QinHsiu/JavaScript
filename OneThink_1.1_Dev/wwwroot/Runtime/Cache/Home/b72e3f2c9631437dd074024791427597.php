...
<div >
	<ul class=" product-show-ul">
	    <li >
	    	<div class="product-content">
			    	...
			    	<div class="right am-u-sm-12 am-u-md-6 am-u-lg-6 product-content-right">
			    		<img class="product-img" src="/OneThink_1.1_Dev/wwwroot/Public/Home/images/hengwangkeji/product2.png" />
			    	</div>	
			    	<div class="clear"></div>
	    	</div>
	    </li>	
	    <li class="gray-li">
	    	<div class="product-content">
			    	<div class="left am-u-sm-12 am-u-md-6 am-u-lg-6 product-content-left">
			    		<img class="product-img" src="/OneThink_1.1_Dev/wwwroot/Public/Home/images/hengwangkeji/product1.png" />
