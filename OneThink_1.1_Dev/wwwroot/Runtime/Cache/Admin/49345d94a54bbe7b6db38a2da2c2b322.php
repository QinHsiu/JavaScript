...
<head>
    ...
    <link href="/OneThink_1.1_Dev/wwwroot/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/OneThink_1.1_Dev/wwwroot/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/OneThink_1.1_Dev/wwwroot/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/OneThink_1.1_Dev/wwwroot/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/OneThink_1.1_Dev/wwwroot/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/OneThink_1.1_Dev/wwwroot/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    <script type="text/javascript" src="/OneThink_1.1_Dev/wwwroot/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/OneThink_1.1_Dev/wwwroot/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/OneThink_1.1_Dev/wwwroot/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
    
	<link rel="stylesheet" href="/OneThink_1.1_Dev/wwwroot/Public/Admin/js/codemirror/codemirror.css">
	<link rel="stylesheet" href="/OneThink_1.1_Dev/wwwroot/Public/Admin/js/codemirror/theme/<?php echo C('codemirror_theme');?>.css">
	<style>
		...
		#preview_window.loading{
			background: url('/OneThink_1.1_Dev/wwwroot/Public/static/thinkbox/skin/default/tips_loading.gif') no-repeat center;
		}
...
'model'=>'Example',		//要查的表
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/OneThink_1.1_Dev/wwwroot", //当前网站地址
            "APP"    : "/OneThink_1.1_Dev/wwwroot/admin.php?s=", //当前项目地址
            "PUBLIC" : "/OneThink_1.1_Dev/wwwroot/Public", //项目公共目录地址
    ...
    <script type="text/javascript" src="/OneThink_1.1_Dev/wwwroot/Public/static/think.js"></script>
    <script type="text/javascript" src="/OneThink_1.1_Dev/wwwroot/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
	...
	<script type="text/javascript" src="/OneThink_1.1_Dev/wwwroot/Public/Admin/js/codemirror/codemirror.js"></script>
	<script type="text/javascript" src="/OneThink_1.1_Dev/wwwroot/Public/Admin/js/codemirror/xml.js"></script>
	<script type="text/javascript" src="/OneThink_1.1_Dev/wwwroot/Public/Admin/js/codemirror/javascript.js"></script>
	<script type="text/javascript" src="/OneThink_1.1_Dev/wwwroot/Public/Admin/js/codemirror/clike.js"></script>
	<script type="text/javascript" src="/OneThink_1.1_Dev/wwwroot/Public/Admin/js/codemirror/php.js"></script>

	<script type="text/javascript" src="/OneThink_1.1_Dev/wwwroot/Public/static/thinkbox/jquery.thinkbox.js"></script>
